...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libComponentsApp = __webpack_require__(175);
	...
	_react2['default'].render(_react2['default'].createElement(
	  ...
	  function () {
	    return _react2['default'].createElement(_libComponentsApp2['default'], null);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libGraphSets = __webpack_require__(179);
	  ...
	  function App(props) {
	    ...
	    this.setPanelSize = function () {
	      ...
	      if (window.clientWidth) {
	        ...
	        console.log('guessing inner width from CSS padding; innerWidth:', window.innerWidth);
	      ...
	      _this.boundAppActions.setPanelSize({
	        width: width,
	    ...
	    (0, _libUtils.addVisibilityHandler)(function (isVisible) {
	      ...
	      if (_this.props.app.autoUpdateInterval) {
	        if (isVisible) {
	          ...
	          _this.boundAppActions.resumeGraphReloading(); // interval
	        } else {
	            _this.boundAppActions.pauseGraphReloading();
	          }
	      }
	    });
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      if (window.location.protocol && window.location.protocol === 'https:') {
	        ...
	        var msg = (0, _libUtils.gettext)('The internally hosted graph server cannot be accessed via HTTPS ' + 'at this time. Edit the URL to HTTP.');
	        return _react2['default'].createElement(_libComponentsError2['default'], { message: msg });
	      }
	      if (this.props.app.error) {
	        ...
	        var conf = (0, _libGraphSets.getGraphSet)(this.props.app.graphSet);
	        if (!conf) {
	          return _react2['default'].createElement(_libComponentsError2['default'], {
	        ...
	        return _react2['default'].createElement(
	          'div',
	          null,
	          _react2['default'].createElement(_libComponentsNavigation2['default'], _extends({
...
/***/ function(module, exports) {
	...
	exports.genId = genId;
	exports.addVisibilityHandler = addVisibilityHandler;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getGraphSet = getGraphSet;
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }
	
	var _libUtils = __webpack_require__(178);
	
	var _addonLifecycle = __webpack_require__(180);
	...
	var graphSetList = [register({
	  key: 'site-performance',
	  name: (0, _libUtils.gettext)('Site Performance'),
	  component: _sitePerf2['default']
	}), register({
	  key: 'search-performance',
	  name: (0, _libUtils.gettext)('Search Performance'),
	  component: _searchPerf2['default']
	}), register({
	  key: 'addon-lifecycle',
	  name: (0, _libUtils.gettext)('Add-on Lifecycle'),
	  component: _addonLifecycle2['default']
	}), register({
	  key: 'validator-perf',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.url = url;
	exports.responseCountUrl = responseCountUrl;
	exports.authResponseCountUrl = authResponseCountUrl;
	...
	var LAST_30_DAYS = '-30days';
	exports.LAST_30_DAYS = LAST_30_DAYS;
	var LAST_90_DAYS = '-90days';
	
	exports.LAST_90_DAYS = LAST_90_DAYS;
	var timeSliceTitles = {};
	...
	timeSliceTitles[LAST_90_DAYS] = (0, _libUtils.gettext)('Last 90 Days');
	
	function url(params) {
	  // This URL is for prod. There is a different one for dev.
	  var renderBase = 'http://graphite.nag.mktmon.services.phx1.mozilla.com/render/';
	  var query = '';
	...
	function authResponseCountUrl() {
	  ...
	  return url(_extends({
	    vtitle: 'scale',
	    target: ['stats.addons.response.auth.200', 'scale(stats.addons.response.200,0.1)']
	  }, params));
	}
	
	function responseTimesUrl() {
	  var _ref3 = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	
	  var params = _objectWithoutProperties(_ref3, []);
	
	  return url(_extends({
	    vtitle: 'milleseconds',
	    target: ['stats.timers.addons.view.GET.lower', 'stats.timers.addons.view.GET.mean', 'stats.timers.addons.view.GET.upper_90', deployMarker()]
	  }, params));
	}
	
	function searchTimesUrl() {
	  var _ref4 = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	
	  var params = _objectWithoutProperties(_ref4, []);
	
	  return url(_extends({
	    vtitle: 'milleseconds',
	    target: ['stats.timers.addons.view.search.views.search.GET.lower', 'stats.timers.addons.search.raw.lower', 'stats.timers.addons.view.search.views.search.GET.mean', 'stats.timers.addons.search.raw.mean', 'stats.timers.addons.view.search.views.search.GET.upper_90', 'stats.timers.addons.search.raw.upper_90', 'scale(stats.timers.addons.view.search.views.search.GET.count,0.1)', 'scale(stats.timers.addons.search.raw.count,0.1)', deployMarker()]
	  }, params));
	}
	
	function redirectsAndErrorsUrl() {
	  var _ref5 = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	
	  var params = _objectWithoutProperties(_ref5, []);
	
	  return url(_extends({
	    vtitle: 'count',
	    target: ['stats.addons.response.301', 'stats.addons.response.302', 'stats.addons.response.304', 'stats.addons.response.400', 'stats.addons.response.403', 'stats.addons.response.404', 'stats.addons.response.405', 'stats.addons.response.500', 'stats.addons.response.503', deployMarker()]
	  }, params));
	}
	...
	function addonValidationTimesUrl() {
	  var _ref9 = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	
	  var params = _objectWithoutProperties(_ref9, []);
	...
	function addonGUIDSearchTimeUrl() {
	  ...
	  return url(_extends({
	    vtitle: 'milleseconds',
	    target: ['stats.timers.addons.view.api.views.guid_search.GET.lower', 'stats.timers.addons.view.api.views.guid_search.GET.mean', 'stats.timers.addons.view.api.views.guid_search.GET.upper_90', 'scale(stats.timers.addons.view.api.views.guid_search.GET.count(0.01)', deployMarker()]
	  }, params));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ValidatorPerf = (function (_Component) {
	  ...
	  function ValidatorPerf() {
	    _classCallCheck(this, ValidatorPerf);
	
	    _get(Object.getPrototypeOf(ValidatorPerf.prototype), 'constructor', this).apply(this, arguments);
	  }
	
	  _createClass(ValidatorPerf, [{
	    key: 'render',
	    value: function render() {
	      var graphProps = this.props.graphProps;
	  ...
	  return ValidatorPerf;
	})(_react.Component);
	
	exports['default'] = ValidatorPerf;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.checkForGraphite = checkForGraphite;
	exports.setTimeSlice = setTimeSlice;
	exports.setPanelSize = setPanelSize;
	exports.reloadGraphImages = reloadGraphImages;
	exports.pauseGraphReloading = pauseGraphReloading;
	exports.resumeGraphReloading = resumeGraphReloading;
	exports.startReloadingGraphs = startReloadingGraphs;
	exports.stopReloadingGraphs = stopReloadingGraphs;
	exports.toggleGraphReloading = toggleGraphReloading;
	exports.viewGraphSet = viewGraphSet;
	...
	function checkForGraphite() {
	  return function (dispatch) {
	    fetch(graphite.responseCountUrl(), { mode: 'no-cors', cache: 'no-cache' }).then(function (response) {
	      ...
	      dispatch({
	        ...
	        error: (0, _libUtils.gettext)("Hmm, the graphs wouldn't load. " + "Make sure you're behind the Mozilla VPN and try again.")
	      });
	    });
	  };
	}
	
	function setTimeSlice(key) {
	  return {
	...
	function startReloadingGraphs() {
	  return function (dispatch, getState) {
	    var state = getState();
	
	    var _startGraphReloader = startGraphReloader(dispatch, state);
	
	    var intervalRef = _startGraphReloader.intervalRef;
	    var updateInterval = _startGraphReloader.updateInterval;
	...
	function viewGraphSet(graphSet) {
	  return {
	...
	function startGraphReloader(dispatch, state) {
	  ...
	  if (updateInterval === 0) {
	    updateInterval = _libReducersApp.initialAppState.autoUpdateInterval;
	  }
	  console.log('starting to reload graphs at interval', updateInterval);
...
/***/ function(module, exports) {
	...
	var DECLARE_PANEL_SIZE = 'DECLARE_PANEL_SIZE';
	exports.DECLARE_PANEL_SIZE = DECLARE_PANEL_SIZE;
	var PAUSE_RELOADING_GRAPHS = 'PAUSE_RELOADING_GRAPHS';
	exports.PAUSE_RELOADING_GRAPHS = PAUSE_RELOADING_GRAPHS;
	var RELOAD_GRAPH_IMAGES = 'RELOAD_GRAPH_IMAGES';
	exports.RELOAD_GRAPH_IMAGES = RELOAD_GRAPH_IMAGES;
	var RESUME_RELOADING_GRAPHS = 'RESUME_RELOADING_GRAPHS';
	exports.RESUME_RELOADING_GRAPHS = RESUME_RELOADING_GRAPHS;
	var SET_TIME_SLICE = 'SET_TIME_SLICE';
	exports.SET_TIME_SLICE = SET_TIME_SLICE;
	var START_RELOADING_GRAPHS = 'START_RELOADING_GRAPHS';
	exports.START_RELOADING_GRAPHS = START_RELOADING_GRAPHS;
	var STOP_RELOADING_GRAPHS = 'STOP_RELOADING_GRAPHS';
	exports.STOP_RELOADING_GRAPHS = STOP_RELOADING_GRAPHS;
	var VIEW_GRAPH_SET = 'VIEW_GRAPH_SET';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialAppState = {
	  ...
	  graphImageNonce: (0, _libUtils.genId)(),
	  // reference to setInterval() instance.
	  graphReloaderInterval: null,
	  graphSet: _libGraphSets.graphSetList[0].key,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navigation = (function (_Component) {
	  ...
	  function Navigation() {
	    ...
	    this.onAutoUpdateChange = function () {
	      _this.props.toggleGraphReloading();
	    };
	
	    this.onChangeGraphSet = function (e) {
	      var sel = e.target;
	      var value = sel.options[sel.selectedIndex].value;
	      console.log('changed graph set to', value);
	      _this.props.viewGraphSet(value);
	    };
	  }
	  ...
	  _createClass(Navigation, [{
	    ...
	    value: function renderMenu() {
	      ...
	      menu.push(_react2['default'].createElement(
	        'select',
	        { key: 'graph-set', value: this.props.currentGraphSet,
	          onChange: this.onChangeGraphSet },
	        _libGraphSets.graphSetList.map(function (set) {
	          return _react2['default'].createElement(
	            'option',
	            { value: set.key },
	            set.name
	      ...
	      Object.keys(graphite.timeSliceTitles).forEach(function (key) {
	        var classes = ['quiet'];
	        if (_this2.props.currentTimeSlice === key) {
	          classes.push('active');
	        }
	        menu.push(_react2['default'].createElement(
	          'button',
	          {
	            key: key, className: _classnames2['default'].apply(undefined, classes),
	            onClick: function () {
	              return _this2.props.setTimeSlice(key);
	            } },
	      ...
	      menu.push(_react2['default'].createElement(
	        ...
	        (0, _libUtils.gettext)('Auto-update')
	      ));
	      return menu;
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: (0, _classnames2['default'])('navigation') },
	        this.renderMenu()
	      );
	    }
	  }], [{
	    key: 'propTypes',
	    value: {
	      autoUpdateInterval: _react.PropTypes.number.isRequired,
	      currentGraphSet: _react.PropTypes.string.isRequired,
	      currentTimeSlice: _react.PropTypes.string.isRequired,
	      toggleGraphReloading: _react.PropTypes.func.isRequired,
	      setTimeSlice: _react.PropTypes.func.isRequired,
	      viewGraphSet: _react.PropTypes.func.isRequired
	    },
	    enumerable: true
	  }, {
	    key: 'defaultProps',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Spinner = (function (_Component) {
	  ...
	  _createClass(Spinner, [{
	    ...
	    key: 'defaultProps',
	    value: {
	      text: (0, _libUtils.gettext)('Loading')
	    },
	    enumerable: true
	  }]);
	  ...
	  return function (next) {
	    return function (action) {
	      if (typeof action.type === 'undefined') {
	        console.error('action.type is undefined.', 'Check that the action is defined in lib/constants/action-types.js');
	      }
